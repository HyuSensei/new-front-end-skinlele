...
export const authLoginAdminToken = createAsyncThunk(
  "auth/authLoginAdminToken",
  async () => {
    try {
      ...
      const res = await axios.get(URL_API + `/admin/authentication/${token}`, {
        withCredentials: true,
      });
      return res.data;
    } catch (error) {
...
export const authSilce = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(authLoginAdminToken.fulfilled, (state, action) => {
